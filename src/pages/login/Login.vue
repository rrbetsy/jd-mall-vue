<template>
  <div class="login">
    <nut-navbar @on-click-back="back">京东登录</nut-navbar>
    <div class="content">
      ...
      <div class="btn-wrap">
        <nut-button
          ...
          @click="login"
        >{{loginBtnName}}</nut-button>
      </div>
      <nut-button block :type="name!==''&&password!==''?'red':'light'" shape="circle">一键登录</nut-button>
      <div class="registe">
      ...
      <div class="login-type">
        <div class="quick-login">
          ...
          <a href="#" class="qq-login icon-wrap">
            <i class="qq-icon"></i>
            <span>QQ</span>
          </a>
          <a href="#" class="wx-login icon-wrap">
            <i class="wx-icon"></i>
            <span>微信</span>
          </a>
        </div>
...
export default {
  ...
  methods: {
    ...
    login: function() {
      ...
      setTimeout(() => {
        localStorage.setItem("jd0user", this.name);
        location.hash = "#/myInfo";
      }, 500);
    }
  }
};
